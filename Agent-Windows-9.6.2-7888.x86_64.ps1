...
$baseUrl="https://trend-dsm-vm01.domain.olog:4119/"
if ( [intptr]::Size -eq 8 ) { 
...
& $Env:ProgramFiles"\Trend Micro\Deep Security Agent\dsa_control" -a dsm://trend-dsm-vm01.domain.olog:4120/ "policyid:1"
Stop-Transcript
